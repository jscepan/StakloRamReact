...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/oyOREwN6kR)
...
```sh
npx nx serve stakloram-react
```

To create a production bundle:

```sh
npx nx build stakloram-react
```

To see all available targets to run for a project, run:

```sh
npx nx show project stakloram-react
```
