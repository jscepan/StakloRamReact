...
export const DOMAIN_INCOMES = 'incomes';
export const DOMAIN_OUTCOMES = 'outcomes';
export const DOMAIN_CITY = 'cities';
export const DOMAIN_IMAGES = 'images';
export const DOMAIN_INVOICES = 'invoices';
export const DOMAIN_ROLES = 'roles';
export const DOMAIN_WORK_ORDERS = 'workorders';
export const DOMAIN_HISTORY = 'histories';
